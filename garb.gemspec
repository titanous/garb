...
Gem::Specification.new do |s|
  s.name = %q{shingara-garb}
  s.version = "0.7.5"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Tony Pitale", 'Cyril Mougel']
  s.date = %q{2010-03-25}
  s.email = %q{tony.pitale@viget.com cyril.mougel@gmail.com}
  ...
  s.has_rdoc = false
  s.homepage = %q{http://github.com/shingara/garb}
  s.require_paths = ["lib"]
